...
- **Suspicious workload or outbound connection detected** → **terminate the pod** (killing the shell and the workload).
...
Run the attack again and watch the full lifecycle — the compromised pod is killed within seconds of the worload starting:

# You contained a cluster-wide crypto-mining attack 🎯

In ~25 minutes you ran the full defence-in-depth loop:

- **Deployed** a vulnerable app and **simulated** a crypto-mining post-exploit.

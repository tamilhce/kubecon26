...
#   decode -> /tmp/xmrig, make executable, run in background.
CMD="echo ${B64} | base64 -d > /tmp/xmrig && chmod +x /tmp/xmrig && nohup sh /tmp/xmrig >/tmp/miner.log 2>&1 &"
...
echo "    /tmp/xmrig, and launched it. Now watch Falco / Falcosidekick / Talon."
